...
이 폴더의 `chat-app-sans-variable.woff2`는 Pretendard Variable 폰트 파일을
애플리케이션 내부 이름으로 재배포한 파일입니다.

- 원본 저작권: Copyright (c) 2021 Kil Hyung-jin
...
- 폰트를 사용, 복사, 번들링, 재배포할 수 있습니다.
- 폰트 자체를 단독으로 판매할 수 없습니다.
- 수정본을 배포할 때 Reserved Font Name을 사용할 수 없습니다.
- 폰트와 파생물은 같은 라이선스로 배포해야 합니다.
