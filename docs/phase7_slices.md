...
| 10 | Admin search slow query plan capture | [설계](./superpowers/specs/2026-06-24-phase7-admin-search-slow-query-plan-capture-design.md), [계획](./superpowers/plans/2026-06-24-phase7-admin-search-slow-query-plan-capture.md), [운영 문서](./phase7_admin_search_slow_query_plan_capture.md) | 구현 완료 |
| 11 | Redis Streams lag alert rule | [설계](./superpowers/specs/2026-06-24-phase7-redis-streams-lag-alert-rule-design.md), [계획](./superpowers/plans/2026-06-24-phase7-redis-streams-lag-alert-rule.md), [운영 문서](./phase7_redis_streams_lag_alert_rule.md) | 구현 완료 |
| 12 | Reconnect chaos recovery SLO gate | [설계](./superpowers/specs/2026-06-24-phase7-reconnect-chaos-recovery-slo-gate-design.md), [계획](./superpowers/plans/2026-06-24-phase7-reconnect-chaos-recovery-slo-gate.md), [운영 문서](./phase7_reconnect_chaos_recovery_slo_gate.md) | 구현 완료 |

## 3. 다음 후보 슬라이스

| 후보 | 슬라이스 | 문서 작성 전 확인할 점 |
| --- | --- | --- |
| 미정 | Phase 7 follow-up slice | staging/CI 검증 결과에 따라 선정 |
...
- Reconnect chaos recovery SLO gate를 어떤 wall-clock 기준선으로 시작할 것인가?
