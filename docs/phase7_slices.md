...
| --- | --- | --- |
| A | Chaos test runbook | Gateway/Worker/Redis/replica 장애 주입과 release blocking 조건 |
| B | WebSocket reconnect chaos orchestration | gateway rolling restart/hard kill을 runner와 연결할 조건 |
