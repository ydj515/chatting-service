...
| --- | --- | --- |
| A | Redis Streams lag/pending 및 writer latency 계측 | gauge/timer semantics, stream shard tag cardinality |
| B | Admin search warm/cold latency gate | warm p95와 cold p99 측정 조건 분리 |
