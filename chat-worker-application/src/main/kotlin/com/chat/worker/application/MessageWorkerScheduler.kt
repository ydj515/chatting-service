...
class MessageWorkerScheduler(
    ...
    @Scheduled(fixedDelayString = "\${chat.worker.poll-delay-millis:100}", scheduler = "writerScheduler")
    fun pollWriter() {
    ...
    @Scheduled(fixedDelayString = "\${chat.worker.poll-delay-millis:100}", scheduler = "fanoutScheduler")
    fun pollFanout() {
